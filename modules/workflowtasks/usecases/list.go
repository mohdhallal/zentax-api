...
func (uc *UseCases) List(ctx context.Context, args sharedtypes.ListArgs) (*sharedtypes.ListResult[domain.WorkflowTask], error) {
	...
	return &sharedtypes.ListResult[domain.WorkflowTask]{
		Items: items,
		Total: total,
	}, nil
}
